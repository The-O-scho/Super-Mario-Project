...
data = read.csv("worlds_data_reordered_by_day.csv")
...
Create time varied data
```{r}
# Create day–level improvement variable

# 1. Compute day-level mean success rate
day_summary = data %>%
  group_by(Day) %>%
  summarise(
